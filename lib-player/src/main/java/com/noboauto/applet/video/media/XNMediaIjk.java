...
public class XNMediaIjk extends XNMediaInterface implements IMediaPlayer.OnPreparedListener, IMediaPlayer.OnVideoSizeChangedListener, IMediaPlayer.OnCompletionListener, IMediaPlayer.OnErrorListener, IMediaPlayer.OnInfoListener, IMediaPlayer.OnBufferingUpdateListener, IMediaPlayer.OnSeekCompleteListener{
    IjkMediaPlayer ijkMediaPlayer;

    public XNMediaIjk(Xnvd jzvd) {
        super(jzvd);
    }
...
//            ////1为硬解 0为软解
            ...
            ijkMediaPlayer.setOnPreparedListener(XNMediaIjk.this);
            ijkMediaPlayer.setOnVideoSizeChangedListener(XNMediaIjk.this);
            ijkMediaPlayer.setOnCompletionListener(XNMediaIjk.this);
            ijkMediaPlayer.setOnErrorListener(XNMediaIjk.this);
            ijkMediaPlayer.setOnInfoListener(XNMediaIjk.this);
            ijkMediaPlayer.setOnBufferingUpdateListener(XNMediaIjk.this);
            ijkMediaPlayer.setOnSeekCompleteListener(XNMediaIjk.this);
