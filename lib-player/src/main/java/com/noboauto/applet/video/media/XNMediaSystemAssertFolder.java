 ...
 * 实现系统的播放引擎
 */
public class XNMediaSystemAssertFolder extends XNMediaInterface implements MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnSeekCompleteListener, MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnVideoSizeChangedListener {

    public MediaPlayer mediaPlayer;

    public XNMediaSystemAssertFolder(Xnvd jzvd) {
        super(jzvd);
    }
    ...
    public void prepare() {
        ...
        mMediaHandler.post(() -> {
            try {
                ...
                mediaPlayer.setOnPreparedListener(XNMediaSystemAssertFolder.this);
                mediaPlayer.setOnCompletionListener(XNMediaSystemAssertFolder.this);
                mediaPlayer.setOnBufferingUpdateListener(XNMediaSystemAssertFolder.this);
                mediaPlayer.setScreenOnWhilePlaying(true);
                mediaPlayer.setOnSeekCompleteListener(XNMediaSystemAssertFolder.this);
                mediaPlayer.setOnErrorListener(XNMediaSystemAssertFolder.this);
                mediaPlayer.setOnInfoListener(XNMediaSystemAssertFolder.this);
                mediaPlayer.setOnVideoSizeChangedListener(XNMediaSystemAssertFolder.this);
    ...
    public boolean onInfo(MediaPlayer mediaPlayer, final int what, final int extra) {
        handler.post(() -> {
            if (what == MediaPlayer.MEDIA_INFO_VIDEO_RENDERING_START) {
                if (jzvd.state == Xnvd.STATE_PREPARING
                        || jzvd.state == Xnvd.STATE_PREPARING_CHANGE_URL) {
                    jzvd.onPrepared();
                }
            } else {
