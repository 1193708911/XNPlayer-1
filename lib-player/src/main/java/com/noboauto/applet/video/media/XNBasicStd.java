 ...
 * 所有关于视频的逻辑都应该写在这里
 */
public class XNBasicStd extends XnvdStd {
    public XNBasicStd(Context context) {
        super(context);
    }

    public XNBasicStd(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        int id = v.getId();
        if (id == cn.xnvd.R.id.surface_container) {
